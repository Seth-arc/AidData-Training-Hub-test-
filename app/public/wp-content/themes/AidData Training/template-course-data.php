                                        ...
                                        <div class="drawer-grid">
                                            ...
                                            <div class="drawer-right">
                                                <div class="info-block" style="padding: 25px;">
                                                    <h2 style="font-size: 20px; color: #026447; font-weight: 600; margin: 0 0 20px 0; font-family: 'Inter'; text-align: left;">Mastering Data Analysis for Development Finance</h2>
                    ...
                    <div class="tab-content" id="overview" style="display: block;">
                                            <div style="display: flex; flex-direction: column; gap: 25px; margin-bottom: 30px;">
                                                ...
                                                <div style="background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">
                                                    <h3 style="color: #026447; font-size: 20px; margin-top: 0; margin-bottom: 15px; font-family: 'Inter'; text-align: left;">Course Description</h3>
                                                    <p style="font-size: 14px; color: #333; line-height: 1.6; margin-bottom: 15px; font-family: 'Inter';">
                                                    ...
                                                    <p style="font-size: 14px; color: #333; line-height: 1.6; font-family: 'Inter';">
                                                ...
                                                <div>
                                                    <h3 style="color: #026447; font-size: 20px; margin-bottom: 20px; font-family: 'Inter'; text-align: left;">Key Learning Outcomes</h3>
                                    ...
                                    <div style="background-color: rgba(248, 249, 250, 0.7); padding: 15px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">
                                        <div style="display: flex; align-items: flex-start; gap: 10px;">
                                            ...
                                            <div>
                                                <h4 style="font-size: 16px; margin-top: 0; margin-bottom: 8px; color: #026447; font-family: 'Inter';">Design Principles</h4>
                                                <p style="font-size: 14px; color: #555; line-height: 1.5; margin: 0; font-family: 'Inter';">Master fundamental design principles and their practical application in creating effective data visualizations for development finance.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style="background-color: rgba(248, 249, 250, 0.7); padding: 15px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">
                                        <div style="display: flex; align-items: flex-start; gap: 10px;">
                                            ...
                                            <div>
                                                <h4 style="font-size: 16px; margin-top: 0; margin-bottom: 8px; color: #026447; font-family: 'Inter';">Accessibility Standards</h4>
                                                <p style="font-size: 14px; color: #555; line-height: 1.5; margin: 0; font-family: 'Inter';">Learn to create inclusive visualizations that effectively communicate to all audiences, regardless of visual abilities or technical background.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style="background-color: rgba(248, 249, 250, 0.7); padding: 15px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">
                                        <div style="display: flex; align-items: flex-start; gap: 10px;">
                                            ...
                                            <div>
                                                <h4 style="font-size: 16px; margin-top: 0; margin-bottom: 8px; color: #026447; font-family: 'Inter';">Data Translation</h4>
                                                <p style="font-size: 14px; color: #555; line-height: 1.5; margin: 0; font-family: 'Inter';">Develop expertise in transforming complex financial data into clear, actionable insights through effective visualization techniques.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style="background-color: rgba(248, 249, 250, 0.7); padding: 15px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">
                                        <div style="display: flex; align-items: flex-start; gap: 10px;">
                                            ...
                                            <div>
                                                <h4 style="font-size: 16px; margin-top: 0; margin-bottom: 8px; color: #026447; font-family: 'Inter';">Analytical Frameworks</h4>
                                                <p style="font-size: 14px; color: #555; line-height: 1.5; margin: 0; font-family: 'Inter';">Apply various analytical perspectives to interpret and present development finance data in meaningful ways.</p>
                                            </div>
                                        </div>
                                    </div>
                                            </div>
                        ...
                        <div class="course-curriculum">
                            <div class="course-modules" style="margin-bottom: 40px;">
                                <div class="module-item" style="margin-bottom: 30px; background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">
                                    <h3 style="color: #026447; font-size: 20px; margin-top: 0; margin-bottom: 15px; font-family: 'Inter';">Module 1: Design Foundations</h3>
                                    <p style="color: #555; line-height: 1.6; font-family: 'Inter';">Master fundamental design principles and their application in data visualization for development finance. Learn how to create effective visual hierarchies, utilize space efficiently, and structure information for maximum clarity and impact.</p>
                                </div>
                                
                                <div class="module-item" style="margin-bottom: 30px; background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">
                                    <h3 style="color: #026447; font-size: 20px; margin-top: 0; margin-bottom: 15px; font-family: 'Inter';">Module 2: Color and Accessibility</h3>
                                    <p style="color: #555; line-height: 1.6; font-family: 'Inter';">Learn to create inclusive visualizations with effective color schemes that communicate clearly to all audiences. Explore color theory, contrast principles, and accessibility standards to ensure your visualizations are comprehensible regardless of viewers' visual abilities.</p>
                                </div>
                                
                                <div class="module-item" style="margin-bottom: 30px; background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">
                                    <h3 style="color: #026447; font-size: 20px; margin-top: 0; margin-bottom: 15px; font-family: 'Inter';">Module 3: Data Fluency</h3>
                                    <p style="color: #555; line-height: 1.6; font-family: 'Inter';">Develop expertise in translating complex development finance data into clear, actionable visual insights. Learn advanced techniques for simplifying complex datasets while maintaining analytical integrity and creating visualizations that effectively communicate your findings.</p>
                                </div>
                                
                                <div class="module-item" style="margin-bottom: 30px; background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05);">
                                    <h3 style="color: #026447; font-size: 20px; margin-top: 0; margin-bottom: 15px; font-family: 'Inter';">Module 4: Analytical Lenses</h3>
                                    <p style="color: #555; line-height: 1.6; font-family: 'Inter';">Apply different analytical perspectives to interpret and present development finance data effectively. Explore various frameworks for understanding and presenting financial data, enabling you to uncover deeper insights and create more meaningful visualizations for diverse stakeholders.</p>
                                </div>
                                ...
                                <div class="module-item" style="margin-bottom: 30px; background-color: rgba(248, 249, 250, 0.7); padding: 20px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05); border-left: 4px solid #026447;">
                                    <h3 style="color: #026447; font-size: 20px; margin-top: 0; margin-bottom: 15px; font-family: 'Inter'; display: flex; align-items: center; gap: 10px;">
                                    ...
                                    <p style="color: #555; line-height: 1.6; font-family: 'Inter';">
                                                ...
                                                <div style="background-color: #f8f9fa; padding: 25px; border-radius: 8px; border: 1px solid rgba(0, 0, 0, 0.05); margin-top: 5px;">
                                                    <div style="display: flex; align-items: flex-start;">
                                                        <div>
                                                            ...
                                                            <p style="font-size: 14px; color: #555; line-height: 1.6; margin-bottom: 15px; font-family: 'Inter';">Full and partial scholarships are available for participants from qualifying regions, with priority given to applicants from low and middle-income countries.</p>
                                                            <a href="#" id="scholarship-inquiry-btn" style="color: #026447; font-size: 14px; font-weight: 500; text-decoration: none; display: inline-flex; align-items: center; gap: 6px; font-family: 'Inter';">
