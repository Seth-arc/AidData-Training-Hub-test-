        ...
        * {
        ...
        .hero {
            background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), 
                        url('../images/china_dashboard.png');
        ...
        <aside class="sidebar">
            ...
            <div class="cta-card">
                ...
                <p style="font-size: 0.875rem; color: #555; line-height: 1.6;">
                    More of the interview can be found <a href="https://www.aiddata.org/publications" target="_blank" style="color: #004E38; text-decoration: underline; font-weight: 500;">here</a>.
                </p>
            </div>
        </aside>
    </main>
