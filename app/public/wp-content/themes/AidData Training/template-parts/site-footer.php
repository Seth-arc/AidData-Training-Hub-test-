 ...
 * Shared site footer.
 *
 * Keep this in sync with the front-page footer design.
 *
 * @package WordPress
...
<footer class="site-footer">
    <div class="footer-content">
        ...
        <div class="footer-section">
            <h4 style="color: #d2bb93;">Quick Links</h4>
            <ul>
        ...
        <div class="footer-section">
            <h4 style="color: #d2bb93;">Resources</h4>
            <ul>
                ...
                <li><a href="https://www.aiddata.org/china" target="_blank">China Research</a></li>
            </ul>
        </div>

        <div class="footer-section">
            <h4 style="color: #d2bb93;">Contact</h4>
            <address>
